	...
	<div class="container mx-auto px-3">
		<div class="table-box-type-1">
			<form action="../member/doModify" method="POST" onsubmit="MemberModify__submit(this); return false;">
				<input type="hidden" name="loginId" value="${rq.loginedMember.userid }" />
				<table border="1">
					<colgroup>
						<col width="200" />
					</colgroup>
					...
					<tbody>
						...
						<tr>
							<th>이름</th>
							<td>
								<input name="name" value="${rq.loginedMember.username }" class="input input-bordered w-full max-w-xs"
						...
						<tr>
							<th>이메일</th>
							<td>
								<input name="email" value="${rq.loginedMember.useremail }" class="input input-bordered w-full max-w-xs"
